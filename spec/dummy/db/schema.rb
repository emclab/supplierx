...
ActiveRecord::Schema.define(:version => 20130826203504) do
  ...
  create_table "authentify_search_stat_configs", :force => true do |t|
  ...
  add_index "authentify_search_stat_configs", ["resource_name"], :name => "index_authentify_search_stat_configs_on_resource_name"
  add_index "authentify_search_stat_configs", ["search_results_url"], :name => "index_authentify_search_stat_configs_on_search_results_url"
